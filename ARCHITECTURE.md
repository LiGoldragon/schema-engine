...
## Revisable leans
Legacy ingestion is an explicit edge adapter for the witness. Native `TextualSchema` authoring can replace it without changing the central Core storage contract.
